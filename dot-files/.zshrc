...
zstyle :compinstall filename '/home/ryuichi/.zshrc'
...
# export JAVA_HOME=`/usr/libexec/java_home` # enable if needed
...
alias jobs="jobs -l"
alias ps="ps au"
alias gitview="git br; echo; git st; echo; git log -n 3 --oneline; echo; git stashl -n 3"
alias python="/usr/local/bin/python" # use same version as pip
alias ..="cd ../"
alias ...="cd ../../"
alias ....="cd ../../../"
alias fx="cd ~/jongla/fxos-jongla"
